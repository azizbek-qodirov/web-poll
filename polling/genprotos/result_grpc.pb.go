...
type ResultServiceClient interface {
	...
	GetPollResults(ctx context.Context, in *ByID, opts ...grpc.CallOption) (*ByIDResponse, error)
}
...
func (c *resultServiceClient) GetPollResults(ctx context.Context, in *ByID, opts ...grpc.CallOption) (*ByIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ResultServiceServer interface {
	...
	GetPollResults(context.Context, *ByID) (*ByIDResponse, error)
...
func (UnimplementedResultServiceServer) GetPollResults(context.Context, *ByID) (*ByIDResponse, error) {
...
func _ResultService_GetPollResults_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResultServiceServer).GetPollResults(ctx, req.(*ByID))
	}
	return interceptor(ctx, in, info, handler)
}
