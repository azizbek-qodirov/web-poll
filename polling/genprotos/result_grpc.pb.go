...
const (
	...
	ResultService_GetPoll_FullMethodName        = "/polling.ResultService/GetPoll"
)
...
type ResultServiceClient interface {
	CreateResult(ctx context.Context, in *CreateResultReq, opts ...grpc.CallOption) (*Void, error)
	SavePollAnswer(ctx context.Context, in *SavePollAnswerReq, opts ...grpc.CallOption) (*Void, error)
	GetPoll(ctx context.Context, in *GetPollReq, opts ...grpc.CallOption) (*GetPollRes, error)
}
...
func (c *resultServiceClient) CreateResult(ctx context.Context, in *CreateResultReq, opts ...grpc.CallOption) (*Void, error) {
...
func (c *resultServiceClient) GetPoll(ctx context.Context, in *GetPollReq, opts ...grpc.CallOption) (*GetPollRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetPollRes)
	err := c.cc.Invoke(ctx, ResultService_GetPoll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ResultServiceServer interface {
	CreateResult(context.Context, *CreateResultReq) (*Void, error)
	SavePollAnswer(context.Context, *SavePollAnswerReq) (*Void, error)
	GetPoll(context.Context, *GetPollReq) (*GetPollRes, error)
...
func (UnimplementedResultServiceServer) CreateResult(context.Context, *CreateResultReq) (*Void, error) {
...
func (UnimplementedResultServiceServer) GetPoll(context.Context, *GetPollReq) (*GetPollRes, error) {
...
func _ResultService_GetPoll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPollReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ResultServiceServer).GetPoll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ResultService_GetPoll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResultServiceServer).GetPoll(ctx, req.(*GetPollReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ResultService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetPoll",
			Handler:    _ResultService_GetPoll_Handler,
		},
	},
